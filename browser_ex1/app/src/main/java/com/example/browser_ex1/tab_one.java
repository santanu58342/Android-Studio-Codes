...
public class tab_one extends AppCompatActivity {
    WebView w1;
    EditText e2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(max>1) {
                    Intent i = new Intent(tab_one.this, MainActivity.class);
                    startActivity(i);
                    max--;
                }
                else{
                    Toast.makeText(tab_one.this, "this is only tab", Toast.LENGTH_SHORT).show();
                }
            }
        });
